...
`amber-lang-ir-probe` is centered on compilers work in Julia. The technical target is: Create a Julia reference implementation for ir workflows, centered on constraint solving, bounded scenario files, and conflict explanations.
...
The score is deterministic. The current threshold is 152. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 3.
